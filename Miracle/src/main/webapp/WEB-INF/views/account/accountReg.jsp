...
<body>
<h1>회원 가입</h1>
<form action="regAccount.do" method="post" enctype="multipart/form-data"
		name="joinForm" onsubmit="return regCheck();">
<div id="regArea">
<div class="id1">ID</div>
<div class="id2"><input id="idInput" name="a_id"></div>
...
<div class="pic2"><input name="a_pic" type="file"></div>
<button>가입</button>
</div>
</form>
</body>
