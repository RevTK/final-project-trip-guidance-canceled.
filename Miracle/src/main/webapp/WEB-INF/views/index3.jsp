...
<!-- ---------------------------------------------------------------------------- -->
<link rel="stylesheet" href="resources/assets3/css/style3.css">
<link rel="stylesheet"
	href="https://vjs.zencdn.net/5-unsafe/video-js.css">
<script src="https://vjs.zencdn.net/5-unsafe/video.js"></script>
<script src="resources/assets3/js/script3.js"></script>
...
<body>
	<div class="container">
		<div class="sidebar">
			<span class="logo">S</span> <a class="logo-expand" href="index.go">skateboard</a>
      ...
      <path fill-rule="evenodd" clip-rule="evenodd"
			...
			<div class="side-wrapper">
				...
				<div class="side-menu">
					<a class="sidebar-link" href="index3.go"> <svg viewBox="0 0 24 24"
							fill="currentColor">
      <path fill-rule="evenodd" clip-rule="evenodd"
					...
					</a> <a class="sidebar-link" href="rec3.main.go"> <svg viewBox="0 0 24 24"
							fill="currentColor">
      <path fill-rule="evenodd" clip-rule="evenodd"
					...
					</a> <a class="sidebar-link" href="event3.main.go"> <svg viewBox="0 0 24 24"
							fill="currentColor">
      <path fill-rule="evenodd" clip-rule="evenodd"
					...
					</a> <a class="sidebar-link" href="myPage3.main.go"> <svg viewBox="0 0 24 24"
							fill="currentColor">
      <path fill-rule="evenodd" clip-rule="evenodd"
