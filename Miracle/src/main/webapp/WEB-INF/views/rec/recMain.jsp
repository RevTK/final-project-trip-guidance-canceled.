...
<html lang="en">
  <head>
    ...
    <link
      href="https://fonts.googleapis.com/css2?family=Pacifico&family=Ubuntu:ital,wght@0,400;0,700;1,400&display=swap"
      rel="stylesheet"
    />
    <link
      ...
      <div class="modal-content">
        <div class="init-content-container" style="display: none">
          <div class="intro-language">
            <h1>
              Discover awesome places in your destination & plan your trip by
              the day
            </h1>
            <p>
              Explore popular places on the map for sightseeing, food, drinks
              and more
            </p>
          ...
          <form id="init-form">
            ...
            <div>
              <a class="show-itineraries">Check out existing itineraries</a>
            </div>
          </form>
        </div>
    ...
    <main class="main-container">
      <section class="planner-container">
        <header>
          ...
          <button class="btn btn-pink show-itineraries">
            ...
            <div class="filter-buttons">
              <li class="filter-li" id="see">
                <a class="btn btn-blue" href="#"
                  ><i class="material-icons">local_see</i>Site</a
                >
              </li>
              <li class="filter-li" id="hotel">
                <a class="btn btn-yellow" href="#"
                  ><i class="material-icons">local_hotel</i>Hotel</a
                >
              </li>
              <li class="filter-li" id="mall">
                <a class="btn btn-green" href="#"
                  ><i class="material-icons">local_mall</i>Shop</a
                >
              </li>
              <li class="filter-li" id="dining">
                <a class="btn btn-orange" href="#"
                  ><i class="material-icons">local_dining</i>Food</a
                >
              </li>
              <li class="filter-li" id="cafe">
                <a class="btn btn-purple" href="#"
                  ><i class="material-icons">local_cafe</i>Cafe</a
                >
              </li>
              <li class="filter-li" id="bar">
                <a class="btn btn-pink" href="#"
                  ><i class="material-icons">local_bar</i>Drinks</a
                >
              </li>
            </div>
