...
$(function() {
	...
	var options = { //지도를 생성할 때 필요한 기본 옵션
		center: new kakao.maps.LatLng(35.1872422, 128.7959181), //지도의 중심좌표.
	...
	var position = new kakao.maps.LatLng(35.1872422, 128.7959181);
...
<div id="map" style="width:100%;height:800px;"></div><br>
