...
<body>
	...
	<header class="header" id="header">
		...
		<nav class="nav container">
			<a href="index.go" class="nav__logo"> <!-- index.go --> <img
				src="resources/img/home/logo.png" alt="logo image"> Travel
			</a> <a href="index2.go">2&nbsp;&nbsp;&nbsp;</a> <a href="index3.go">3&nbsp;&nbsp;&nbsp;</a>
			...
			<div class="nav__menu" id="nav-menu">
				<ul class="nav__list">
					...
					<li class="nav__item"><a class="nav__link"><jsp:include
								page="${loginPage }"></jsp:include></a> <!-- myPage5.main.go --></li>
				</ul>
		...
		<div class="footer__container container grid">
			...
			<div class="footer__content">
				...
				<div>
					...
					<ul class="footer__links">
						<li class="footer__information">서울특별시 미라클시 <br> 미라클빌딩
							777호
						</li>
					</ul>
				</div>
