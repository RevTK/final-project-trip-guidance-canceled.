		...
		<div class="video-stream">
          ...
          <path d="M20 6L9 17l-5-5" />
           ...
           <path fill-rule="evenodd" clip-rule="evenodd"
					...
					<div class="video-p-title anim" style="-delay: .2s">Basic how
						to ride your Skateboard</div>
         ...
         <path fill-rule="evenodd" clip-rule="evenodd"
          ...
          <path d="M20 6L9 17l-5-5" />
			...
			<div class="chat-vid__container">
				...
				<div class="chat-vid__button anim" style="-delay: .6s">See All
					related videos (32)</div>
			</div>
		</div>
	</div>
</body>
