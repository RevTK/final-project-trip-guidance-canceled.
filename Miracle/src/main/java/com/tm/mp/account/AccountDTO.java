...
public class AccountDTO {
	...
	public AccountDTO(String ac_id, String ac_pw, String ac_pwConfirm, int ac_linkWhere, String ac_name, String ac_addr,
			String ac_email, String ac_pic) {
		super();
		this.ac_id = ac_id;
		this.ac_pw = ac_pw;
	...
	public int getAc_linkWhere() {
		return ac_linkWhere;
	}

	public void setAc_linkWhere(int ac_linkWhere) {
		this.ac_linkWhere = ac_linkWhere;
	}
